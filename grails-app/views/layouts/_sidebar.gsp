...
<section>
    <ul class="nav nav-tabs nav-stacked">
        <li class="${(controllerName == 'request' && !(actionName in ['reportBySchool', 'requestsBy', 'report', 'detail'])) ? 'active' : 'no-active'}">
        ...
        <ds:isAdmin>
            ...
            <li class="${controllerName == 'request' && actionName in ['reportBySchool', 'requestsBy', 'report', 'detail'] ? 'active' : ''}">
