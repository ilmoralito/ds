...
<section>
    <ul class="nav nav-tabs nav-stacked">
        <li class="${(controllerName == 'request' && !(actionName in ['reportBySchool', 'reportByClassrooms', 'reportByApplicant', 'coordinationReportPerApplicant', 'reportByDatashows', 'requestsBy', 'report', 'detail'])) ? 'active' : 'no-active'}">
        ...
        <ds:isAdmin>
            ...
            <li class="${controllerName == 'request' && actionName in ['reportBySchool', 'reportByClassrooms', 'reportByApplicant', 'coordinationReportPerApplicant', 'reportByDatashows', 'requestsBy', 'report', 'detail'] ? 'active' : ''}">
