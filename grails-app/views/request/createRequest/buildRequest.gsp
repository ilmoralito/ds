...
<body>
	<g:if test="${type == 'express'}">
		<div class="row">
			<div class="span10">
				<a href="#" id="popover" data-content="Por cada solicitud expreso, el solicitante se compromete a cumplir las condiciones listadas en la seccion <a href='/normas'>Normas de uso</a>" data-toggle="popover" data-original-title="Sobre solicitudes express" data-placement="bottom">
