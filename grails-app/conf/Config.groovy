...
ni.edu.uccleon.schools = ['Ciencias Economicas Empresariales','Administracion Turistica y Hotelera','Ciencias Juridicas Empresariales','Ciencias Agragrias','Ingenieria e Informatica','Estudios por encuentro superior','Especializacion','Administracion', 'Protocolo', 'Promotoria', 'Direccion Academica', 'Vice Rectoria General']
